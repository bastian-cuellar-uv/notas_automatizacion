...
public class notas {
    ...
    public static void main(String[] args) {
        ...
        // Ingresar RUT
        driver.findElement(By.cssSelector(".p-inputnumber-input")).sendKeys("9693870");
        // Seleccionar PORTAL
        ...
        wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath("//table[@id='pr_id_14-table']/tbody/tr[2]/td[6]/div/button")));
        WebElement ramo = driver.findElement(By.xpath("//table[@id='pr_id_14-table']/tbody/tr[2]/td[6]/div/button"));
        js.executeScript("arguments[0].click();", ramo);
        // Wait<WebDriver> wait2 = new WebDriverWait(driver, Duration.ofSeconds(60));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@type='button'])[13]")));
        WebElement notasPar = driver
                .findElement(By.xpath("(//button[@type='button'])[13]"));
        js.executeScript("arguments[0].click();", notasPar);

        for (int i = 0; i <= 100; i++) {
            int numero = (int) (Math.random() * 7) + 1;
            String nota = String.valueOf(numero);
            wait.until(ExpectedConditions.elementToBeClickable(By.id("nota_0_" + i)));
            if (i < 10) {
                driver.findElement(By.id("nota_0_" + i)).sendKeys(nota);
                driver.findElement(By.id("nota_0_10" + i)).sendKeys(nota);
                driver.findElement(By.id("nota_0_20" + i)).sendKeys(nota);
            } else {
                driver.findElement(By.id("nota_0_" + i)).sendKeys(nota);
                driver.findElement(By.id("nota_0_1" + i)).sendKeys(nota);
                driver.findElement(By.id("nota_0_2" + i)).sendKeys(nota);
            }
